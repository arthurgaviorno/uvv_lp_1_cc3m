...
class TestInvertida(unittest.TestCase):
    ...
    def test_invertida_2(self):
        teste_inv2_image = pset1.Imagem(1, 4,
                                        [29,89,136,200])
        resultado = teste_inv2_image.invertida()                        
        esperado = pset1.Imagem(1, 4,
                                [226, 166, 119, 55])
        self.assertTrue(resultado, esperado)



    '''MEU TESTE DA QUESTAO 2
    def test_invertida_3(self):
        imagem = pset1.Imagem.carregar('test_images/cat.png')
        invertida = imagem.invertida()
        pset1.Imagem.salvar(invertida, 'resultados_imagens/cat1.png')'''
